...
class AttributeController {
    ...
    def get(){
        ...
        try{
            result = attributeService.getAttributes(params)
    ...
    def add(){
        ...
        try{
            result = attributeService.createAttribute(request.JSON)
    ...
    def put(){
        ...
        try{
            ...
            result = attributeService.modifyAttribute(params, request.JSON)
            response.setStatus( HttpServletResponse.SC_OK)
            render result as GSON
